...
@Component({
  selector: 'app-edi-al1',
  templateUrl: './edi-al1.component.html',
  styleUrls: ['./edi-al1.component.css']
})

export class EdiAl1Component implements OnInit,OnChanges {
  ...
  editarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.editarcurso1(Alumnos).then(()=>{

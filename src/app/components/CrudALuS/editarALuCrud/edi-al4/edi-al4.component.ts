...
@Component({
  selector: 'app-edi-al4',
  templateUrl: './edi-al4.component.html',
  styleUrls: ['./edi-al4.component.css']
})

export class EdiAl4Component implements OnInit,OnChanges {
  ...
  editarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.editarcurso4(Alumnos).then(()=>{

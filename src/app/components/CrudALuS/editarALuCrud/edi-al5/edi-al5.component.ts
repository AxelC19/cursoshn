...
@Component({
  selector: 'app-edi-al5',
  templateUrl: './edi-al5.component.html',
  styleUrls: ['./edi-al5.component.css']
})

export class EdiAl5Component implements OnInit,OnChanges {
  ...
  editarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.editar5curso(Alumnos).then(()=>{

...
@Component({
  selector: 'app-edi-al7',
  templateUrl: './edi-al7.component.html',
  styleUrls: ['./edi-al7.component.css']
})

export class EdiAl7Component implements OnInit,OnChanges {
  ...
  editarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.editar7curso(Alumnos).then(()=>{

...
@Component({
  selector: 'app-edi-instr',
  templateUrl: './edi-instr.component.html',
  styleUrls: ['./edi-instr.component.css']
})


export class EdiInstrComponent implements OnInit,OnChanges {
  ...
  editarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.editarinstructor(Alumnos).then(()=>{

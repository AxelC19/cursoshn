...
@Component({
  selector: 'app-agregar-instr',
  templateUrl: './agregar-instr.component.html',
  styleUrls: ['./agregar-instr.component.css']
})

export class AgregarInstrComponent implements OnInit {
  crearAl:FormGroup;
  l:string[]=[];
  ...
  agregarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.apreglinstructor(Alumnos).then(()=>{

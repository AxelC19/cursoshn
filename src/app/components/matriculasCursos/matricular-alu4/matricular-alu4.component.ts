...
@Component({
  selector: 'app-matricular-alu4',
  templateUrl: './matricular-alu4.component.html',
  styleUrls: ['./matricular-alu4.component.css']
})
export class MatricularAlu4Component implements OnInit {
  ...
  agregarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.curso4AluAgregar(Alumnos).then(()=>{

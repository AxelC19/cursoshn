...
@Component({
  selector: 'app-matricular-alu2',
  templateUrl: './matricular-alu2.component.html',
  styleUrls: ['./matricular-alu2.component.css']
})
export class MatricularAlu2Component implements OnInit {
  crearAl:FormGroup;
  l:string[]=[];
  ...
  constructor( private router:Router,
   ...
   {        
     this.crearAl = this.fb.group({
      ...
      curso:['Seguridad Informática Personal'],
     })
  ...
  agregarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.curso2AluAgregar(Alumnos).then(()=>{

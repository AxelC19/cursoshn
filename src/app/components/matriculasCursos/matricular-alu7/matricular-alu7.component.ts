...
@Component({
  selector: 'app-matricular-alu7',
  templateUrl: './matricular-alu7.component.html',
  styleUrls: ['./matricular-alu7.component.css']
})
export class MatricularAlu7Component implements OnInit {
  crearAl:FormGroup;
  l:string[]=[];
  ...
  constructor( private router:Router,
   ...
   {        
     this.crearAl = this.fb.group({
      ...
      curso:['El internet de las cosas'],
     })
  ...
  agregarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.curso7AluAgregar(Alumnos).then(()=>{

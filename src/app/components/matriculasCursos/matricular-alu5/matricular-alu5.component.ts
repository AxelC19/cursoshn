...
@Component({
  selector: 'app-matricular-alu5',
  templateUrl: './matricular-alu5.component.html',
  styleUrls: ['./matricular-alu5.component.css']
})
export class MatricularAlu5Component implements OnInit {
  ...
  agregarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.curso5AluAgregar(Alumnos).then(()=>{

...
@Component({
  selector: 'app-matricular-alu6',
  templateUrl: './matricular-alu6.component.html',
  styleUrls: ['./matricular-alu6.component.css']
})
export class MatricularAlu6Component implements OnInit {
  crearAl:FormGroup;
  l:string[]=[];
  ...
  agregarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.curso6AluAgregar(Alumnos).then(()=>{

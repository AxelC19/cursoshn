...
@Component({
  selector: 'app-MatricularAlu',
  templateUrl: './MatricularAlu.component.html',
  styleUrls: ['./MatricularAlu.component.css']
})
export class MatricularAluComponent implements OnInit {
  ...
  agregarAlumnos(){
    ...
    this.cargar= true;
    const envio:any = this.firestore.curso1AluAgregar(Alumnos).then(()=>{
